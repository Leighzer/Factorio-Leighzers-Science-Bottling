data:extend({
    {
        ...
        minable = {mining_time = 0.1, result = "bottling-plant"},
        max_health = 300,
        corpse = "big-remnants",
        ...
        {
          {
            filename = "__leighzersciencebottling__/graphics/entity/bottling-plant/bottling-plant.png",
            width = 122,
            height = 134,
            frame_count = 1,
            ...
            hr_version =
            {
              filename = "__leighzersciencebottling__/graphics/entity/bottling-plant/hr-bottling-plant.png",
              width = 244,
              height = 268,
              frame_count = 1,
              shift = util.by_pixel(-5, -4.5),
        ...
        energy_source =
        {
          ...
          emissions_per_second_per_watt = ((4 / 210000) / 2) --half of regular chem plant
        },
        energy_usage = "100kW",
